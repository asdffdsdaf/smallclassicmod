...
import com.mojang.minecraft.render.ChunkVisibleDistanceComparator;
...
import com.mojang.minecraft.render.texture.AnimatedTexture;
import com.mojang.minecraft.render.texture.LavaTexture;
import com.mojang.minecraft.render.texture.WaterTexture;
...
public final class Minecraft implements Runnable {
   ...
   public final void run() {
      ...
      try {
         ...
         this.textureManager.registerAnimation(new LavaTexture());
         this.textureManager.registerAnimation(new WaterTexture());
                     ...
                     if(!var66.minecraft.online) {
                        ...
                        if(var66.minecraft.level != null) {
                           ...
                           while(true) {
                              ...
                              if(var81.minecraft.settings.jetpack) {
                                 if(var81.minecraft.settings.speed) {
                                    this.player.jetspeed = 1.0F;
                                 } else {
                                    this.player.jetspeed = 0.42F;
                                 }
                                 this.player.jetpack = true;

                              } else {
                                 this.player.jetpack = false;
                              }
                              if(var81.minecraft.settings.speed) this.timer.speed = 3.5F; else this.timer.speed = 1F;
                              ...
                              Frustum var77 = FrustumImpl.update();
                              Frustum var96 = var77;
                              ...
                              Collections.sort(var81.minecraft.levelRenderer.chunks, new ChunkVisibleDistanceComparator(var123));
      ...
      if(var1 != 0 || this.blockHitTime <= 0) {
         ...
         if(var1 == 1 && (var3 = this.player.inventory.getSelected()) > 0 && this.gamemode.useItem(this.player, var3)) {
            ...
            if(this.selected.entityPos == 1) {
               ...
               if(var1 == 0) {
                  if(var6 != Block.STATIONARY_WATER || this.player.userType >= 100) {
   ...
   private void tick() {
      ...
      for(var16 = 0; var16 < var18.animations.size(); ++var16) {
         ...
         (var3 = (AnimatedTexture)var18.animations.get(var16)).anaglyph = var18.settings.anaglyph;
         var3.animate();
      ...
      if(this.currentScreen == null || this.currentScreen.grabsMouse) {
         ...
         while(Keyboard.next()) {
            ...
            if(Keyboard.getEventKeyState()) {
               ...
               if(Keyboard.getEventKey() == this.settings.toggleJetpackKey.key) {
                  this.settings.toggleSetting(8, !Keyboard.isKeyDown(42) && !Keyboard.isKeyDown(54)?1:-1);
               }

               if(Keyboard.getEventKey() == this.settings.toggleSpeedKey.key) {
                  this.settings.toggleSetting(9, !Keyboard.isKeyDown(54)?1:-1);
               }
            }
         }
   ...
   public final void setLevel(Level var1) {
      ...
      if(this.levelRenderer != null) {
         ...
         if(this.levelRenderer.level != null) {
            var3.level.removeRenderer(var3);
         }

         var3.level = var1;
         if(var1 != null) {
            var1.addRenderer(var3);
            var3.refresh();
         }
      }
