...
public final class LevelGenerator {
   ...
   private long flood(int var1, int var2, int var3, int var4, int var5) {
      ...
      int var22 = var6 + 1;
      this.floodData[0] = ((var2 << var8) + var3 << var7) + var1;
      long var11 = 0L;
         ...
         for(; var14 < var15; ++var14) {
            ...
            if(var3 > 0) {
               if((var19 = this.blocks[var2 - this.width] == 0) && !var23) {
                  if(var22 == this.floodData.length) {
                     var21.add(this.floodData);
                     this.floodData = new int[1048576];
                     var22 = 0;
                  }

                  this.floodData[var22++] = var2 - this.width;
               }
            ...
            if(var13 > 0) {
               ...
               if((var19 = var25 == 0) && !var18) {
                  ...
                  this.floodData[var22++] = var2 - var1;
               }
