...
public final class FrustumImpl extends Frustum {
   ...
   public static Frustum update() {
      FrustumImpl var0 = instance;
      ...
      var0.frustum[0][0] = var0.clipping[3] - var0.clipping[0];
      var0.frustum[0][1] = var0.clipping[7] - var0.clipping[4];
      var0.frustum[0][2] = var0.clipping[11] - var0.clipping[8];
      var0.frustum[0][3] = var0.clipping[15] - var0.clipping[12];
      normalize(var0.frustum, 0);
      var0.frustum[1][0] = var0.clipping[3] + var0.clipping[0];
      var0.frustum[1][1] = var0.clipping[7] + var0.clipping[4];
      var0.frustum[1][2] = var0.clipping[11] + var0.clipping[8];
      var0.frustum[1][3] = var0.clipping[15] + var0.clipping[12];
      normalize(var0.frustum, 1);
      var0.frustum[2][0] = var0.clipping[3] + var0.clipping[1];
      var0.frustum[2][1] = var0.clipping[7] + var0.clipping[5];
      var0.frustum[2][2] = var0.clipping[11] + var0.clipping[9];
      var0.frustum[2][3] = var0.clipping[15] + var0.clipping[13];
      normalize(var0.frustum, 2);
      var0.frustum[3][0] = var0.clipping[3] - var0.clipping[1];
      var0.frustum[3][1] = var0.clipping[7] - var0.clipping[5];
      var0.frustum[3][2] = var0.clipping[11] - var0.clipping[9];
      var0.frustum[3][3] = var0.clipping[15] - var0.clipping[13];
      normalize(var0.frustum, 3);
      var0.frustum[4][0] = var0.clipping[3] - var0.clipping[2];
      var0.frustum[4][1] = var0.clipping[7] - var0.clipping[6];
      var0.frustum[4][2] = var0.clipping[11] - var0.clipping[10];
      var0.frustum[4][3] = var0.clipping[15] - var0.clipping[14];
      normalize(var0.frustum, 4);
      var0.frustum[5][0] = var0.clipping[3] + var0.clipping[2];
      var0.frustum[5][1] = var0.clipping[7] + var0.clipping[6];
      var0.frustum[5][2] = var0.clipping[11] + var0.clipping[10];
      var0.frustum[5][3] = var0.clipping[15] + var0.clipping[14];
      normalize(var0.frustum, 5);
      return instance;
   }
