...
public class TextureManager {
   ...
   public final int load(String var1) {
      ...
      if(var2 != null) {
         ...
         try {
            ...
            if(var1.startsWith("##")) {
               this.load(loadSub(ImageIO.read(TextureManager.class.getResourceAsStream(var1.substring(2)))), var4);
            } else {
   ...
   public static BufferedImage loadSub(BufferedImage var0) {
   ...
   public final void registerAnimation(AnimatedTexture var1) {
